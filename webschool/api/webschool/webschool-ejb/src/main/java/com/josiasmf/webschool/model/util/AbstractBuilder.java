...
public class AbstractBuilder<T, B extends AbstractBuilder> {
    ...
    protected void validate() {
        ...
        if (!validateEntity.isEmpty()) {
            ...
            throw new ConstraintViolationException(message.getPropertyPath().toString()
                    .concat(": ").concat(message.getMessage()), validateEntity);
        }
        ...
        if (!validateBuilder.isEmpty()) {
            ...
            throw new ConstraintViolationException(message.getPropertyPath().toString()
                    .concat(": ").concat(message.getMessage()), validateBuilder);
        }
    }
